                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                @if (!empty($getRecord->getImg()))
                                    <img src="{{ $getRecord->getImg() }}" style="margin-top:5px;height:150px;">
                                @endif
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="meta_title" required
                                    value="{{ $getRecord->meta_title }}" placeholder="">
                            </div>
                            <div class="form-group">
                                <label>Meta Description</label>
                                <textarea class="form-control" name="meta_description"
                                    value="{{ $getRecord->meta_description }}" placeholder=""></textarea>
                            </div>
                            <div class="form-group">
                                <label>Meta Keywords</label>
                                <input type="text" class="form-control" name="meta_keywords"
                                    value="{{ $getRecord->meta_keywords }}" placeholder="">
                            </div>
                        </div>
