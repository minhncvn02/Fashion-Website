    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Cập nhật thông tin mã giảm giá</h1>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="type" required>
                                    <option {{ (old('type', $getRecord->type) == 'Tiền mặt') ? 'selected' : '' }} value="Tiền mặt">Tiền mặt</option>
                                    <option {{ (old('type', $getRecord->type) == '% giá trị') ? 'selected' : '' }} value="% giá trị">% giá trị</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="percent_amount" required
                                    value="{{ old('percent_amount', $getRecord->percent_amount) }}" placeholder="">
                            </div>
